 ...
 * @returns {Uint8Array}
 */
export function compute_create2_address(factory_address, salt, bytecode_hash) {
  ...
  const ret = wasm.compute_create2_address(ptr0, len0, ptr1, len1, ptr2, len2)
...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === "undefined") {
    module_or_path = "./keccak_wasm_bg.wasm"
  }
  const imports = __wbg_get_imports()
