...
export const Button: React.FC<Props> = ({
  ...
  const button = (
    <button
      disabled={disabled}
      className={cn(
        "inline-block rounded outline-none",
        {
          "bg-indigo-500 text-white hover:bg-indigo-600 active:opacity-50":
            !transparent && !outline,
          ...
          "text-xs": size === "xs",
          "border border-gray-200 text-gray-600 hover:border-gray-400 hover:text-gray-900 dark:border-gray-700 dark:text-gray-400 dark:hover:border-gray-500 dark:hover:text-white":
            outline,
        },
        className,
      )}
